...
const DoctorsSchema = new SimpleSchema({
  ...
  homeAddress: {
    type: AddressSchema,
    label: 'The home address of the user this doctor profile belongs to.',
  },
  practiceName: {
    type: AddressSchema,
    label: 'The home address of the user this doctor profile belongs to.',
  ...
  practiceAddress: {
    type: AddressSchema,
    label: 'The practice address of the user this doctor profile belongs to.',
  },
  practicePhone: {
    type: String,
  ...
  dateOfBirth: {
    type: Date,
    label: 'The date of birth of the user this doctor profile belongs to.',
  },
  lastFourSSN: {
    type: String,
    label: 'The last four social security numbers of the user this doctor profile belongs to.',
  },
  doctorId: {
    type: String,
